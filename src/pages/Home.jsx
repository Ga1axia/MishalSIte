...
export default function Home() {
  ...
  return (
    <>
      ...
      {current ? (
        ...
        <section className="hero">
          <div className="container">
            <Reveal>
              <p className="label">{gallery?.name || '25 West Gallery'}</p>
              <h1 className="display" style={{ margin: '0.4rem 0 1.2rem', maxWidth: '18ch' }}>
                {copy(gallery, 'homeBetweenHeadline')}
              </h1>
              <p className="lede muted" style={{ marginBottom: '1.6rem', maxWidth: '40ch' }}>
                {copy(gallery, 'homeBetweenMessage')}
              </p>
              <Link to="/exhibitions" className="btn">All exhibitions</Link>
            </Reveal>
          </div>
        </section>
      )}
      ...
      <section className="section" style={{ paddingTop: upcoming.length > 0 ? 0 : undefined }}>
        <div className="container">
          <Reveal className="section-head">
